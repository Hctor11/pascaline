  ...
  return (
    <nav className=" w-full shadow-sm bg-white ">
      <div className="lg:w-[75%] lg:m-auto md:px-5 py-3 px-3 flex items-center justify-between">
        <div className="cursor-pointer z-20 md:w-auto flex w-full justify-between">
          <Link href="/">
        ...
        {/* responsive menu */}
        <ul
          className={`md:hidden gap-5 touch-pan-x bg-white fixed overflow-hidden w-full h-full bottom-0 pt-24 pl-4 duration-500 z-10 ${
